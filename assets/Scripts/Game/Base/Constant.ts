export class Constant {
  ...
  public static EVENT_TYPE = {
    SYS_DEBUG: "sysDebug",
    SYS_MUSIC_MUTE: "sysMusicMute",
    SYS_SOUND_MUTE: "sysSoundMute",
    GAME_PAUSE: "gamePause",
    GAME_RESUME: "gameResume",
    
    UI_MAIN_LOADING_PROGRESS: "uiMainLoadingProgress",
    UI_TOUCH_START: "uiTouchStart",
    UI_TOUCH_MOVE: "uiTouchMove",
    UI_TOUCH_CANCEL: "uiTouchCancel",
    UI_TOUCH_END: "uiTouchEnd",
    UI_UPDATE_DATA: "uiUpdateData",
    HP_EMPTY: "hpEmpty",
    HP_FULL: "hpFull",
    DATA_UPDATE_PLAYER: "dataUpdatePlayer",
    LEVEL_CHANGE: "levelChange",
    PLAYER_MAT_CHANGE: "PlayerMatChange",
    ...
    HIDE_DEBUG_PANEL: "hideDebugPanel",
  ...
  public static SOUND = {
    CLICK: "click", //按钮点击
    START_GAME_CLICK: "homePanelClick", //主界面点击按钮
